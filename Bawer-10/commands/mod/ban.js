...
//envia msg no pv da pessoa----------------|
        ...
        if(!usu.bannable) return message.channel.send(`:x: | ${message.author} O usuario mencionado tem um cargo maior que o meu! Suba meu cargo para o topo e execute o comando novamente! Obrigada`);
